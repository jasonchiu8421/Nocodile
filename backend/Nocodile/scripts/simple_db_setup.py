...
def create_database():
    ...
    try:
        ...
        cursor.execute("CREATE DATABASE IF NOT EXISTS nocodile_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci")
        cursor.execute("USE nocodile_db")
