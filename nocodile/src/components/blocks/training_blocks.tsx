import { Block, BlockRegistry, BlockType, CreateBlockElementProps } from "@/components/blocks/blocks"
import { EndBlockComponent } from "@/components/blocks/common_blocks"
...
const EndAndUploadBlockComponent = (props: CreateBlockElementProps<EndBlockProps>) => {
  ...
  return (
    <EndBlockComponent stage="training" saveFunc={saveFunc} allBlocks={allTrainingBlocks} data={{}} setData={() => {}} {...filterOutKeys(props, ["data", "setData"])} step={startTraining}>
