  ...
  return (
    <div className="font-sans min-w-screen min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link href="/dashboard" className="flex p-6 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors shadow-lg">
        ...
        <Link href="/annotate" className="flex p-6 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors shadow-lg">
          <div className="text-center">
        ...
        <Link href="/blocks" className="flex p-6 bg-amber-600 text-white rounded-xl hover:bg-amber-700 transition-colors shadow-lg">
          <div className="text-center">
            <div className="text-2xl mb-2">🧱</div>
        ...
        <Link href="/workflow" className="flex p-6 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-colors shadow-lg">
          <div className="text-center">
            <div className="text-2xl mb-2">⚡</div>
        ...
        <Link href="/home" className="flex p-6 bg-gray-600 text-white rounded-xl hover:bg-gray-700 transition-colors shadow-lg">
          <div className="text-center">
            <div className="text-2xl mb-2">🏠</div>
