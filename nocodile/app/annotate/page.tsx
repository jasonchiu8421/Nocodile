...
export default function AnnotatePage() {
  ...
  const currentClass = classes.find(c => c.id === selectedClass) || classes[4];
  ...
  const handleAddClass = () => {
    ...
    for (const entry of entries) {
      ...
      if (nextClasses.some(c => c.id === generatedId)) { lastAddedId = generatedId; continue; }
    ...
    const totalPages = Math.max(1, Math.ceil(nextClasses.length / CLASSES_PER_PAGE));
    setClassPage(totalPages);
    setNewClassName('');
  };
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-6">
          ...
          <nav className="space-y-2">
            <div className="flex items-center p-3 rounded-lg text-gray-500 hover:bg-gray-50 cursor-pointer">
              <Cloud className="w-5 h-5 mr-3" />
              <span>Upload</span>
            </div>
            <div className="flex items-center p-3 rounded-lg bg-blue-50 text-blue-700 border border-blue-200 cursor-pointer">
      ...
      <div className="w-80 bg-white border-l border-gray-200 flex flex-col">
        ...
        <div className="p-4 border-b border-gray-200">
          ...
          <div className="flex items-center space-x-2 mb-3">
            ...
            />
            <Button onClick={handleAddClass} className="bg-blue-600 hover:bg-blue-700 text-white">Add</Button>
          </div>
