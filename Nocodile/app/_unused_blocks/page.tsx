...
import { ImagesBlockData } from "./components/blocks/ImagesBlock";
import { FieldBlockData } from "./components/blocks/FieldBlock";
...
const test_blocks: (GenericBlockData | ImagesBlockData | FieldBlockData)[] = [
  {
    id: 1,
    x: 0,
    y: 0,
...
const page = () => {
  const [blocks, setBlocks] = useState<(GenericBlockData | ImagesBlockData | FieldBlockData)[]>(test_blocks);
